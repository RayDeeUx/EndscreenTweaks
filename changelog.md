...
- Aggressive trimming to minimize arbitrary CRLF snafus.
## v1.8.8
...
- Added `Show Total Attempts + Jumps`
  - This was mostly for parity with that one private mod Doggie uses in his videos.
## v1.7.1
